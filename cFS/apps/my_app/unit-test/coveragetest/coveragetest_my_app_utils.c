...
void Test_MY_APP_TblValidationFunc(void)
{
    ...
    UtAssert_INT32_EQ(MY_APP_TblValidationFunc(&TestTblData), CFE_SUCCESS);

    /* error case should return MY_APP_TABLE_OUT_OF_RANGE_ERR_CODE */
    TestTblData.Int1 = 1 + MY_APP_TBL_ELEMENT_1_MAX;
    UtAssert_INT32_EQ(MY_APP_TblValidationFunc(&TestTblData), MY_APP_TABLE_OUT_OF_RANGE_ERR_CODE);
}
