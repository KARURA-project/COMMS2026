...
#include "my_app_eds_dispatcher.h"
#include "my_app_eds_dictionary.h"

/*
 * Define a lookup table for SAMPLE app command codes
 */
static const EdsDispatchTable_MY_APP_Application_CFE_SB_Telecommand_t SAMPLE_TC_DISPATCH_TABLE = {
    .CMD     = {.NoopCmd_indication          = MY_APP_NoopCmd,
            .ResetCountersCmd_indication = MY_APP_ResetCountersCmd,
            .ProcessCmd_indication       = MY_APP_ProcessCmd,
            .DisplayParamCmd_indication  = MY_APP_DisplayParamCmd},
    .SEND_HK = {.indication = MY_APP_SendHkCmd}};
...
void MY_APP_TaskPipe(const CFE_SB_Buffer_t *SBBufPtr)
{
    ...
    Status = EdsDispatch_MY_APP_Application_Telecommand(SBBufPtr, &SAMPLE_TC_DISPATCH_TABLE);
