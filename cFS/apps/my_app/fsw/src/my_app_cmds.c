...
CFE_Status_t MY_APP_NoopCmd(const MY_APP_NoopCmd_t *Msg)
{
    ...
    CFE_EVS_SendEvent(MY_APP_NOOP_INF_EID, CFE_EVS_EventType_INFORMATION, "SAMPLE: NOOP command %s",
                      MY_APP_VERSION);
...
CFE_Status_t MY_APP_ResetCountersCmd(const MY_APP_ResetCountersCmd_t *Msg)
{
    ...
    CFE_EVS_SendEvent(MY_APP_RESET_INF_EID, CFE_EVS_EventType_INFORMATION, "SAMPLE: RESET command");
